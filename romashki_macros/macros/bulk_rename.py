...
обозначения, комментария) для выбранных компонентов в сборке.
...
Макрос недоработан; работоспособность не гарантируется.
"""
...
def _print_properties(filename: str = "") -> None:
    """
...
if __name__ == "__main__":
    ...
    ods_path = ods_utils.create_temp_ods_filepath(TEMP_FOLDER)
