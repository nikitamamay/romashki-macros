"""
Модуль графического интерфейса макроса `surface_and_demand`.

Графический интерфейс позволяет:
* применить обозначение общей шероховатости и текст технических требований;
* настроить применяемые тексты шероховатости и технических требований.
