...
"Зеркальный массив" именно для тела.

Макрос создает операцию "Зеркальный массив" для каждого из выбранных тел
относительно выбранной плоскости.

Макрос актуален для старых версий Компаса, в которых нет возможности выбрать
сразу несколько тел для создания зеркального массива за одну операцию.
